...
The changes were based on the comments from the opposition group last week and the feedback from our examiner.

** Writing
  Furthermore, Jacob made some minor improvements to the bibliography of the report according to the feedback the group received from the examiner.
...
** Development
  Previously, the roofs of buildings were displayed incorrectly and the ocean appeared gray.
  This was solved by changing the shader for these into the *Standard Unity Shader* that follows the *.glTF* specification.
...
Furthermore, the opposition group, consisting of Viktor Truvé and Anton Håkansson, prepared questions and comments for the opposing group.
Every group member also wrote, and submitted their individual evaluation.
