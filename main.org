...
so Viktor started using an asset called [[https://assetstore.unity.com/packages/3d/vegetation/trees/realistic-tree-9-rainbow-tree-54622]["Realistic Tree 9 [Rainbow Tree]"]] on the
...
- The first iteration is divided into the following workload:
  ...
  4. General application functionality, block generation and possibly some CI.
...
[[fig:road_intersection_test]], which also demonstrates the RTree used in action.
