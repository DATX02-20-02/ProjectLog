...
This problem was not something we anticipated would cause a huge boost in
performance. However, this was because the L-System based building generator had
not been implemented into the application yet, and buildings are very heavy on
textures.
