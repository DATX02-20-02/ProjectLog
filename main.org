...
#+BEGIN_COMMENT
Road LOD done
Spiny skyscrapers fixed
Broken plot division from week 10 fixed. The library we had chosen
had some problems and we had made some of our own as well.
Buildings finalized and optimized with LOD and mesh merges.
#+END_COMMENT
...
Terrain color gradient adjusted to now correctly contain snowy mountains
Fixed stone/tree/bush not appearing in parks
#+END_COMMENT
