...
During the final week, some minor adjustments on the report were made.
This included rendering a new cover image for the report with updated materials that render correctly in Blender.
