...
so Viktor started using an asset called [[https://assetstore.unity.com/packages/3d/vegetation/trees/realistic-tree-9-rainbow-tree-54622]["Realistic Tree 9 [Rainbow Tree]"]] on the Unity Asset Store that creates
