...
** Development
  ...
  is compatible with the *.glTF* specification, and hence, are displayed correctly in Blender.
...
** Decisions
#+begin_decisions
- Theodor will be mainly responsible for creating the exhibition video, and the
  other members will give him feedback.
#+end_decisions
...
drink some beer.
A bit late perhaps for having our first teambuilding session, but better late
...
Anton spent a lot of time this week improving the road mesh, creating better
textures for intersections.
However, it lead to lots of issues that turned out to be very difficult to fix,
so we decided to delay and eventually abandon it due to the time requirement of
fixing it.
We simply decided that there were other, more important things to focus on
instead, such as the report, opposition and final presentation.
...
which are randomly assigned from the plot generator. See Figure [[fig:skyscraper1]] and [[fig:skyscraper2]].

#+begin_columns
#+begin_column
#+CAPTION: Dynamic sizes of skyscrapers.
#+NAME: fig:skyscraper1
[[./images/week11/skyscraper.gif]]
#+end_column
#+begin_column
#+CAPTION: Dynamic windows of skyscrapers.
#+NAME: fig:skyscraper2
[[./images/week11/skyscraper2.gif]]
#+end_column
#+end_columns
